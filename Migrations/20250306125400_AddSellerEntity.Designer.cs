...
namespace Auction_System.Migrations
{
    ...
    [Migration("20250306125400_AddSellerEntity")]
    partial class AddSellerEntity
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Auction_System.Models.AuctionEvent", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            EndingTime = new TimeSpan(0, 10, 0, 0, 0),
                            ItemId = 0,
                            Name = "9 AM - 10 AM",
                        ...
                        {
                            Id = 2,
                            EndingTime = new TimeSpan(0, 13, 0, 0, 0),
                            ItemId = 0,
                            Name = "12 PM - 1 PM",
                        ...
                        new
                        {
                            ...
                            ItemId = 0,
                            Name = "3 PM - 4 PM",
                            StartingTime = new TimeSpan(0, 15, 0, 0, 0)
                        });
                });
            ...
            modelBuilder.Entity("Auction_System.Models.Message", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Auction_System.Models.Message", b =>
                {
                    b.HasOne("Auction_System.Models.AppUser", "Recipient")
                        .WithMany()
